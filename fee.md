...
- **`FeeStructure` & `FeeComponent`:** To define standard fees by Program, Batch, Academic Year, and Curriculum (fee structures are curriculum specific) (e.g., Tuition, Transport, Hostel, Misc).
