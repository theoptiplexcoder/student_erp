...
- *Primary app(s)* points to the `apps/` entry in `project_structure.md` the persona mostly lives in. Many personas touch more than one app via the API gateway.
...
*Primary app(s): web-admin-console (platform-level surface)*
...
*Primary app(s): web-admin-console*
...
*Primary app(s): web-admin-console + services/worker, services/scheduler, services/ingestion*
...
*Primary app(s): web-admin-console (billing surface)*
...
*Primary app(s): web-admin-console (security surface)*
...
*Primary app(s): web-admin-console (strategic dashboard, mostly read-only)*
...
*Primary app(s): web-admin-console (scoped to assigned campuses)*
...
*Primary app(s): web-faculty-portal*
...
### 4.1 Applicant
*Primary app(s): web-student-portal (pre-enrollment mode)*
...
### 4.2 Student
*Primary app(s): web-student-portal, mobile*
...
### 4.3 Alumni
*Primary app(s): web-student-portal (alumni view)*
...
*Primary app(s): web-admin-console (admissions module)*
...
*Primary app(s): web-admin-console (examination module)*
...
### 7.2 Online Proctor
*Primary app(s): web-admin-console (proctoring review queue)*
...
### 8.1 Finance Staff
*Primary app(s): web-admin-console (finance module)*
...
### 13.1 Health Staff
*Primary app(s): app-medical-wellness*
...
### 16.1 IT Staff
*Primary app(s): web-admin-console (IT module)*
...
*Primary app(s): app-student-activities*
...
### 20.1 Recruiter
*Primary app(s): app-placement (external-facing view)*
...
*Primary app(s): portal-auditor (regulatory reporting view)*
...
*Primary app(s): portal-corporate-client*
...
*These are interaction flows, not human journeys — written from the system's point of view.*
...
5. **Permission boundary** — She cannot approve her *own* exam moderation request or grade her *own* course's exam papers if institution policy walls off conflicts of interest — the system enforces this at the permission level, independent of which "hat" she's wearing when she logs in.
