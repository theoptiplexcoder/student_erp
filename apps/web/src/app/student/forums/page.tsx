...
export default function ForumsPage() {
  const threads = [
    {
      id: 1,
      title: 'Question about the Mid-Term Syllabus',
      course: 'CS301',
      author: 'Priya Sharma',
      replies: 5,
      time: '2 hours ago',
    ...
    {
      id: 2,
      title: 'Project Group Search - Team of 3',
      course: 'CS302',
      author: 'Rahul Kumar',
      replies: 12,
      time: '1 day ago',
    ...
    {
      id: 3,
      title: 'Help with graph algorithm implementation',
      course: 'CS301',
      author: 'Alex Johnson',
      replies: 2,
      time: '3 days ago',
  ...
  return (
    <div className="mx-auto flex h-full max-w-7xl flex-col gap-6 pb-10">
      ...
      <div className="grid grid-cols-1 gap-4">
        {threads.map((thread) => (
          <Card key={thread.id} className="transition-shadow hover:shadow-md">
            <div className="flex flex-col gap-4 p-6 sm:flex-row">
              ...
              <div className="text-muted-foreground flex min-w-[120px] flex-row items-center justify-between gap-4 text-sm sm:flex-col sm:items-end sm:justify-center">
