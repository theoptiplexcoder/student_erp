...
export function TimetableEntryForm({
  ...
  const { data: coursesData } = useAdminCourses(1, 50, '', '', '', '', { enabled: open });
        ...
        <div className="grid gap-4 py-4">
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <select
              ...
              className="border-input bg-background col-span-3 flex h-10 w-full rounded-md border px-3 py-2 text-sm"
            >
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <select
              id="day"
              defaultValue={entry?.dayOfWeek || 'MONDAY'}
              className="border-input bg-background col-span-3 flex h-10 w-full rounded-md border px-3 py-2 text-sm"
            >
          ...
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              defaultValue={
                entry?.startTime ? new Date(entry.startTime).toISOString().substring(11, 16) : ''
              }
            />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
            ...
            <Input
              ...
              className="col-span-3"
              defaultValue={
                entry?.endTime ? new Date(entry.endTime).toISOString().substring(11, 16) : ''
              }
            />
          </div>
          <div className="grid grid-cols-4 items-center gap-4">
